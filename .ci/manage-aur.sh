...
parse-gitdiff() {
    # List file changes between scheduled tag and HEAD
    _CURRENT_DIFF=$(git --no-pager diff --name-only scheduled..HEAD)
    ...
    for package in "${_PKG[@]}"; do
        ...
        if ! git diff --exit-code --quiet; then
            ...
            git commit -m "chore: update $package" \
                -m "This commit was automatically generated by Chaotic-AUR's CI pipeline." \
                -m "The changelog can be found at https://github.com/chaotic-aur/pkgbuilds." \
